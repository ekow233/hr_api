...
class AppHelper
{
      ...
      public static function instance()
     {
      ...
      /**
       * CHECK FOR COMPANY STRUCTURE PERMISSIONS
       */

      public function checkCreateCompStructurePerm($user){
            //find the user and get all the roles
            $user = User::find($user)->roles->all();
            ...
            //if it exist then return true else false
            foreach($perms as $perm){
                  if($perm->name == "company-structure/add"){
                        return true;
                  }
            }
            return false;
      ...
      public function checkEditCompStructurePerm($user){
            //find the user and get all the roles
            $user = User::find($user)->roles->all();
            ...
            //if it exist then return true else false
            foreach($perms as $perm){
                  if($perm->name == "company-structure/edit"){
                        return true;
                  }
            }
            return false;
      ...
      public function checkViewCompStructurePerm($user){
            //find the user and get all the roles
            $user = User::find($user)->roles->all();
            ...
            //if it exist then return true else false
            foreach($perms as $perm){
                  if($perm->name == "company-structure/view"){
                        return true;
                  }
            }
            return false;
